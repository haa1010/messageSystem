...
class TestCheckMessage {
	...
	@Test
	void testFrddMissing() {
		Message mess = new Message("Fr BA", 8088, "0987654321");
		Message mess1 = new Message("Frdddd gh Fr", 8088, "0987654321");
		mess.exe();
		mess1.exe();
	...
	@Test
	void testRejoin() {
		Message mess = new Message("Frd B", 8080, "0977117123");
		Message mess1 = new Message("Frd B", 8011, "0977117123");
		Message mess2 = new Message("Frd RJ", 8011, "0977117123");
		mess.exe();
		mess1.exe();
		mess2.exe();
